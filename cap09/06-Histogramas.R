setwd("C:/Cursos/Cuso_DSA/praticando_dia_a_dia/cap09")
...
hist(dados, main = "Número de Acidentes Diários", xlab = "Acidentes", ylab = "Frequência", breaks = 6)#alterando a qt de barras
hist(dados, main = "Número de Acidentes Diários", xlab = "Acidentes", ylab = "Frequência", breaks = 5)#alterando a qt de barras
?hist
